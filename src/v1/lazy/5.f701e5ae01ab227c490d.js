    ...
    [5],
    {
            ...
            (function (t) {
              var e =
                  (t.defaultIntegrations &&
                    Object(r.e)(t.defaultIntegrations)) ||
                  [],
                n = t.integrations,
                i = [];
              if (Array.isArray(n)) {
                ...
                e.forEach(function (t) {
                  -1 === o.indexOf(t.name) &&
                    -1 === a.indexOf(t.name) &&
                    (i.push(t), a.push(t.name));
                }),
                  n.forEach(function (t) {
                    -1 === a.indexOf(t.name) && (i.push(t), a.push(t.name));
                  });
              } else
                "function" == typeof n
              ...
              return (
                -1 !== s.indexOf(c) &&
                  i.push.apply(i, Object(r.e)(i.splice(s.indexOf(c), 1))),
                i
              );
            })(t).forEach(function (t) {
              (e[t.name] = t),
        ...
        var y = (function () {
          ...
          return (
            ...
            (t.prototype._updateSessionFromEvent = function (t, e) {
              ...
              t.update(
                Object(r.a)(Object(r.a)({}, s && { status: o.a.Crashed }), {
                  user: d,
                  userAgent: a,
            ...
            (t.prototype._prepareEvent = function (t, e, n) {
              ...
              n &&
                n.captureContext &&
                (f = i.a.clone(f).update(n.captureContext));
              var d = u.a.resolve(c);
              return (
                f && (d = f.applyToEvent(c, n)),
                d.then(function (t) {
                  return "number" == typeof s && s > 0
                    ? o._normalizeEvent(t, s)
                    : t;
                })
              );
            }),
                    ...
                    Object(r.a)(
                      ...
                      t.breadcrumbs && {
                        breadcrumbs: t.breadcrumbs.map(function (t) {
                          return Object(r.a)(
                            Object(r.a)({}, t),
                            t.data && { data: Object(f.d)(t.data, e) },
                          );
                        }),
                      },
                    ),
                    t.user && { user: Object(f.d)(t.user, e) },
                  ),
                  t.contexts && { contexts: Object(f.d)(t.contexts, e) },
                ),
                t.extra && { extra: Object(f.d)(t.extra, e) },
              );
              return (
                t.contexts &&
                  t.contexts.trace &&
              ...
              return !c && "number" == typeof a && Math.random() > a
                ...
                : this._prepareEvent(t, n, e)
                    .then(function (t) {
                      ...
                      if ((e && e.data && !0 === e.data.__sentry__) || c || !o)
                        return t;
                      var n = o(t, e);
                      if (void 0 === n)
                        throw new h.a(
      ...
      "7gXM": function (t, e, n) {
        ...
        function i(t) {
          try {
            for (
              var e = t, n = [], r = 0, i = 0, a = " > ".length, s = void 0;
              e &&
              r++ < 5 &&
              !(
                "html" === (s = o(e)) ||
      ...
      DNLO: function (t, e, n) {
        ...
        function o(t) {
          for (var e = [], n = 1; n < arguments.length; n++)
            e[n - 1] = arguments[n];
          var o = Object(i.b)();
          if (o && o[t]) return o[t].apply(o, Object(r.e)(e));
          throw new Error(
            "No hub defined or " +
              t +
        ...
        function s(t, e) {
          ...
          var i = "string" != typeof e ? { captureContext: e } : void 0;
          return o(
            "captureMessage",
            t,
      ...
      Fbu0: function (t, e, n) {
        ...
        function s(t, e, n) {
          var a = {
            ...
            extra: { __serialized__: Object(i.e)(t) },
          };
          if (e) {
            var s = u(Object(o.a)(e).stack);
            ...
            return (
              (t.prototype.setupOnce = function () {
                Object(i.b)(function (e, n) {
                  var r = Object(o.b)().getIntegration(t);
              ...
              (t.prototype._handler = function (t, e) {
                ...
                return (
                  (t.exception.values = Object(r.e)(n, t.exception.values)), t
                );
              }),
              (t.prototype._walkErrorTree = function (t, e, n) {
                ...
                var i = Object(c.a)(t[e]),
                  o = Object(s.c)(i);
                return this._walkErrorTree(t[e], e, Object(r.e)([o], n));
              }),
              (t.id = "LinkedErrors"),
              t
            );
                ...
                Object(i.b)(function (e) {
                  ...
                  if (Object(o.b)().getIntegration(t)) {
                    ...
                    var c =
                      ...
                      f = Object(r.a)(Object(r.a)({}, c && { url: c }), {
                        headers: l,
                      });
                    return Object(r.a)(Object(r.a)({}, e), { request: f });
                  }
                  return e;
                });
              }),
          ...
          f = (function () {
            function t(t) {
              (this.options = t),
                ...
                (this._rateLimits = {}),
                (this._api = new i.a(t.dsn, t._metadata)),
            ...
            return (
              ...
              (t.prototype._handleRateLimit = function (t) {
                ...
                if (s) {
                  try {
                    for (
                      var u = Object(r.f)(s.trim().split(",")), l = u.next();
                      !l.done;
                      l = u.next()
                    ) {
                      ...
                      try {
                        for (
                          var v = ((i = void 0), Object(r.f)(f[1].split(";"))),
                            _ = v.next();
                          !_.done;
                          _ = v.next()
                        ) {
      ...
      "Lw/n": function (t, e, n) {
        ...
        function o(t) {
          (t._metadata = t._metadata || {}),
            void 0 === t._metadata.sdk &&
              (t._metadata.sdk = {
                name: "sentry.javascript.react",
                packages: [{ name: "npm:@sentry/react", version: r.a }],
                version: r.a,
              }),
            Object(i.e)(t);
        }
          ...
          c = (function () {
            ...
            return (
              ...
              (t.prototype.addBreadcrumb = function (t, e) {
                var n = Object(r.a)({ timestamp: Object(o.a)() }, t);
                return (
                  (this._breadcrumbs =
                    void 0 !== e && e >= 0
                      ? Object(r.e)(this._breadcrumbs, [n]).slice(-e)
          ...
          h = (function (t) {
            ...
            return (
              ...
              (e.prototype.eventFromException = function (t, e) {
                return Object(l.a)(this._options, t, e);
              }),
              (e.prototype.eventFromMessage = function (t, e, n) {
                return (
                  void 0 === e && (e = u.a.Info),
                  Object(l.b)(this._options, t, e, n)
                );
              }),
      ...
      T87Q: function (t, e, n) {
            ...
            return (
              (t.prototype.update = function (t) {
                void 0 === t && (t = {}),
                  ...
                  t.sid &&
                    (this.sid = 32 === t.sid.length ? t.sid : Object(o.i)()),
            ...
            return (
                  ...
                  if (!(f <= 0)) {
                    var d = Object(a.a)(),
                      ...
                      v = p
                        ...
                        : h;
                    null !== v && i.addBreadcrumb(v, Math.min(f, 100));
                  }
                }
              }),
              (t.prototype.setUser = function (t) {
              ...
              (t.prototype.startSession = function (t) {
                ...
                if (n) {
                  ...
                  p && p.status === i.a.Ok && p.update({ status: i.a.Exited }),
                    this.endSession(),
                    n.setSession(u);
                }
                return u;
        ...
        function v() {
          var t = d();
          return (
            (_(t) && !b(t).isOlderThan(3)) || y(t, new f()),
            Object(c.b)()
              ? (function (t) {
                  var e, n, r;
                  try {
                    var i =
                      null ===
                        ...
                        : r.active;
                    if (!i) return b(t);
                    if (!_(i) || b(i).isOlderThan(3)) {
                      var o = b(t).getStackTop();
                      y(i, new f(o.client, u.a.clone(o.scope)));
                    }
                    return b(i);
                  } catch (a) {
                    return b(t);
            ...
            if (
              ((e = (function (t) {
                ...
                for (
                  ...
                  !r.func && r.line && (r.func = i), p.push(r);
                }
                if (!p.length) return null;
                return { message: d(t), name: t.name, stack: p };
              })(t)),
              e)
            )
              return f(e, n);
            ...
            return (
              ...
              (t.prototype._wrapEventTarget = function (t) {
                ...
                n &&
                  ...
                  (Object(o.c)(n, "addEventListener", function (e) {
                ...
                return function () {
                  ...
                  return (
                    i.forEach(function (t) {
                      t in r &&
                        "function" == typeof r[t] &&
                        Object(o.c)(r, t, function (e) {
                          var n = {
                            mechanism: {
                              data: { function: t, handler: Object(a.a)(e) },
                              handled: !0,
                              type: "instrument",
                            },
                          };
                          return (
                            e.__sentry_original__ &&
                              (n.mechanism.data.handler = Object(a.a)(
                                e.__sentry_original__,
                              )),
                            Object(s.c)(e, n)
                          );
      ...
      X2UX: function (t, e, n) {
        ...
        var r = n("mrSG"),
          ...
          u = n("VojH");
        function p(t, e, n) {
          var r = f(e, (n && n.syntheticException) || void 0, {
            attachStacktrace: t.attachStacktrace,
          });
          return (
            Object(o.a)(r, { handled: !0, type: "generic" }),
            (r.level = i.a.Error),
        ...
        function l(t, e, n, r) {
          void 0 === n && (n = i.a.Info);
          var o = d(e, (r && r.syntheticException) || void 0, {
            attachStacktrace: t.attachStacktrace,
          });
          return (
            (o.level = n),
        ...
        function f(t, e, n) {
          ...
          if ((void 0 === n && (n = {}), Object(s.e)(t) && t.error))
            return (t = t.error), (i = Object(c.b)(Object(u.a)(t)));
          if (Object(s.a)(t) || Object(s.b)(t)) {
            ...
            return (
              ...
              Object(o.b)(i, l),
              "code" in a &&
                (i.tags = Object(r.a)(Object(r.a)({}, i.tags), {
                  "DOMException.code": "" + a.code,
                })),
              i
            );
          }
          if (Object(s.d)(t)) return (i = Object(c.b)(Object(u.a)(t)));
          if (Object(s.h)(t) || Object(s.f)(t)) {
            var f = t;
            return (
              (i = Object(c.a)(f, e, n.rejection)),
              Object(o.a)(i, { synthetic: !0 }),
              i
            );
          }
          return (
            (i = d(t, e, n)),
            Object(o.b)(i, "" + t, void 0),
            Object(o.a)(i, { synthetic: !0 }),
            i
          );
        }
      ...
      XLoa: function (t, e, n) {
        ...
        function o(t, e) {
          return e
            ? ((t.sdk = t.sdk || { name: e.name, version: e.version }),
              (t.sdk.name = t.sdk.name || e.name),
              (t.sdk.version = t.sdk.version || e.version),
              (t.sdk.integrations = Object(r.e)(
                t.sdk.integrations || [],
                e.integrations || [],
              )),
              (t.sdk.packages = Object(r.e)(
                t.sdk.packages || [],
                e.packages || [],
              )),
              t)
        ...
        function s(t, e) {
          var n = i(e),
            ...
            p = Object(r.d)(c, ["transactionSampling"]),
            l = u || {},
            f = l.method,
            d = l.rate;
        ...
        var u = (function (t) {
            ...
            void 0 === n &&
              (n = (function () {
                var t,
                  e,
                  n = Object(o.e)();
                if (Object(a.a)(n.fetch)) return n.fetch.bind(n);
                var r = n.document,
                  i = n.fetch;
                if (
                  "function" ==
                  ...
                  try {
                    ...
                    (c.hidden = !0),
                      ...
                      (null === (e = c.contentWindow) || void 0 === e
                        ? void 0
                        : e.fetch) && (i = c.contentWindow.fetch),
          ...
          return (
            ...
            (e.prototype.sendEvent = function (t) {
              return this._sendRequest(Object(i.a)(t, this._api), t);
            }),
            (e.prototype.sendSession = function (t) {
              return this._sendRequest(Object(i.b)(t, this._api), t);
            }),
            (e.prototype._sendRequest = function (t, e) {
              ...
              var r = {
                body: t.body,
                method: "POST",
                referrerPolicy: Object(a.e)() ? "origin" : "",
              };
              return (
        ...
        function f(t) {
          if ((void 0 === t && (t = {}), t.eventId))
            if (t.dsn) {
              ...
              (e.async = !0),
                (e.src = new o.a(t.dsn).getReportDialogEndpoint(t)),
          ...
          if (!d[t])
            switch (((d[t] = !0), t)) {
                        ...
                        Object(c.c)(l.console, t, function (e) {
                          return function () {
                            ...
                            _("console", { args: n, level: t }),
                              e &&
                                Function.prototype.apply.call(e, l.console, n);
                          };
                        });
                    },
                  );
                ...
                !(function () {
                  ...
                  (l.onpopstate = function () {
                    ...
                    var i = l.location.href,
                      o = r;
                    if (((r = i), _("history", { from: o, to: i }), t))
                      return t.apply(this, e);
                  }),
              ...
              case "unhandledrejection":
                (E = l.onunhandledrejection),
                  (l.onunhandledrejection = function (t) {
                    return (
                      _("unhandledrejection", t), !E || E.apply(this, arguments)
                    );
                  });
                break;
              default:
            ...
            return (
                  ...
                  (Object(s.a)({
                    callback: function (n) {
                      ...
                      if (a && !Object(l.b)() && !s) {
                        ...
                        Object(u.a)(d, { handled: !1, type: "onerror" }),
                          o.captureEvent(d, { originalException: r });
                      }
                    },
                    type: "error",
                  }),
              ...
              (t.prototype._enhanceEventWithInitialFrame = function (
                ...
                var i = isNaN(parseInt(r, 10)) ? void 0 : r,
                  ...
                  a = Object(c.k)(e) && e.length > 0 ? e : Object(u.f)();
                return (
        ...
        (function (t) {
          ...
          function b(t, e) {
            ...
            for (var r = n.length; r > 0; r--) {
              ...
              if (!(i.length > e))
                return r === n.length ? i : Object(c.d)(i, e);
            }
            return "";
          }
          function y(t) {
            ...
            return (
              ...
              (t.prototype._getPossibleEventMessages = function (t) {
                ...
                if (t.exception)
                  try {
                    ...
                    return (
                      u.a.error(
                        "Cannot extract message for event " + Object(p.d)(t),
                      ),
                      []
                    );
                  }
              ...
              (t.prototype._getEventFilterUrl = function (t) {
                try {
                  ...
                  return (
                    u.a.error("Cannot extract url for event " + Object(p.d)(t)),
                    null
                  );
                }
              }),
      ...
      xPfL: function (t, e, n) {
        ...
        function y(t) {
          if (
            (void 0 === t && (t = {}),
            void 0 === t.defaultIntegrations && (t.defaultIntegrations = b),
            void 0 === t.release)
          ) {
            var e = Object(a.e)();
            e.SENTRY_RELEASE &&
        ...
        function g(t) {
          void 0 === t && (t = {}),
            t.eventId || (t.eventId = Object(o.b)().lastEventId());
        ...
        function E(t) {
          var e = Object(o.b)().getClient();
          return e ? e.flush(t) : s.a.reject(!1);
        }
        function S(t) {
          var e = Object(o.b)().getClient();
          return e ? e.close(t) : s.a.reject(!1);
        }
        function x(t) {
          return Object(l.c)(t)();
        }
...
//# sourceMappingURL=../sourcemaps/lazy/5.f701e5ae01ab227c490d.js.map
