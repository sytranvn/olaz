"object" != typeof globalThis && (globalThis = window),
  (function (t) {
    function e(e) {
      for (
        var o, i, a = e[0], c = e[1], d = e[2], m = 0, u = [];
        m < a.length;
        m++
      )
        (i = a[m]),
      ...
      e.default = class {
        constructor(t) {
          (this.flsData = void 0),
            ...
            (this.flsData = {}),
            (this.recordedData = {});
          const { safeFpsGap: e = 10, maxFps: n = 60 } = t || {};
          this.safeFps = n - e;
        }
        onData(t) {
          this.listener = t;
    ...
    EqIC: function (t, e, n) {
      ...
      var l = class {
          ...
          getExtraTransferInfo() {
            if (
              ...
              return { processData: o.a.DataManager.freezeProcessData(t) };
            }
          }
        },
        u = n("KBA3");
      ...
      class h {
        ...
        serialize() {
          return { key: this.key, data: this.data, error: this.error };
        }
        static deserialize(t) {
          ...
          (this.messageChannel = void 0),
            ...
            (this.onMessage = (t) => {
              t.forEach((t) => {
                if (o.a.process === m.a.Main) {
                  var e;
                  const { fromClientId: b, action: P, data: I } = t;
                  var n;
                  if (
                            ...
                            null === (e = this.sender) ||
                              ...
                              e.send(
                                ...
                                "resRun",
                                {
                                  response: t,
                                  func:
                                    null === (n = I.reqRun) || void 0 === n
                                      ? void 0
                                      : n.func,
                                  args:
                                    (null === (o = I.reqRun) || void 0 === o
                                      ? void 0
                                      : o.args) || [],
                                },
                                { immediate: !0, toClientId: b },
                              );
                          });
      ...
      class b {
        ...
        handleRequest(t, e) {
          ...
          if (!i) {
            ...
            return void n(null, { message: e.message, name: e.name });
          }
          const s = i(...t.args);
        ...
        class {
          ...
          transmitFps(t, e, n) {
            this.sender.send(
              ...
              "fps",
              Object(a.a)(
                { processName: o.a.process, recordAt: e, usageTime: n },
                t,
              ),
            );
          }
          transmitFpsSection(t, e) {
            this.sender.send(
              ...
              "fps",
              Object(a.a)({ processName: o.a.process, taskKey: e }, t),
            );
          }
      ...
      var v = class {
        ...
        add(t, e) {
          this.events.some((n) => n.name === t && n.time === e) ||
            this.events.push({ name: t, time: e });
        }
        saveEpoch(t) {
      ...
      class D {
        ...
        enqueue(t) {
          return new Promise((e, n) => {
            this._items.push({ task: t, resolve: e, reject: n }),
              setTimeout(() => {
                this.execute();
              }, 0);
          });
            ...
            r.setStartAt(Date.now()),
              ...
              this.AutoQueue.enqueue(async () => {
                const n = Object(_.a)(e),
                  s = { dataSize: n, readableDataSize: Object(A.c)(n) };
                r.setData(s),
                  r.setDuration(n),
                  r.pushInfo(s),
                  i && r.pushInfo(i),
      ...
      class F extends C {
        ...
        exposeInfo() {
          return { usage: this.usage, passedTime: this.passedTime };
        }
        resolve() {
          super.resolve();
        }
        ...
        get MetriczLogWriter() {
          return (
            this._metriczLogWriter ||
              (this._metriczLogWriter = { write: (t) => {} }),
            this._metriczLogWriter
          );
        }
        createLogger(t) {
      ...
      o.a.register(
        ...
        class extends class {
          ...
          isValidEvent(t) {
            return (
              !!super.isValidEvent(t) &&
              [M.a.app_did_mount, M.a.app_ready].includes(t)
            );
          }
          getMetricInstances() {
          ...
          async loadWebSystemInfo() {
            try {
              ...
              if (
                ...
                null != t &&
                  t.architecture &&
                  (this.webSystemInfo = { arch: t.architecture });
              }
            } catch (n) {}
          }
          ready() {
        ...
        class {
          constructor() {
            (this._fpsTimeline = void 0),
              ...
              (this.fpsFallingConfig = { safeFpsGap: 10 }),
              ...
              (this.recordFpsMetric = (t) => {
                if (
                  ...
                  return;
                const e = Date.now(),
                  { metrics: n, passedTime: i, startTime: s } = t,
          ...
          get avgFpsCounter() {
            return (
              this._avgFpsCounter ||
                (this._avgFpsCounter = { _columnNo: 0, _total: 0 }),
              this._avgFpsCounter
            );
          }
          get fpsSections() {
          ...
          recordFps(t, e, n) {
            this.isActive &&
              ...
              this.triggerEvent(Z.a.FPS, { fps: t.fps, now: n }));
          }
          getFps() {
          ...
          endRecordSectionFps(t, e, n) {
            ...
            const d = Object(a.a)(
              Object(a.a)({}, s.result || {}),
              {},
              { startAt: s.startAt, endAt: r, maxFps: this.maxFps },
            );
            if (
    ...
    K6Wi: function (t, e, n) {
      ...
      const B = (t) => {
        ...
        U = Object(r.f)({
          ...
          points: [
            r.f.Point({ name: "", condition: !0, qos: { cmdId: 99775 } }),
          ],
        }),
        G = Object(r.c)({
        ...
        statement: Object(r.f)({
          ...
          points: [
            r.f.Point({
              name: "maxFps = 60",
              condition: (t) => {
                const { maxFps: e } = z.extractLowestFpsDrop(t);
                return !!(null != e && e <= 60);
              },
              points: [
                r.f.Point({
                  name: "fps <= 10",
                  condition: (t) => {
                    const { lowestDrop: e } = z.extractLowestFpsDrop(t);
                    return !!(null != e && e <= 10);
                  },
                  points: [
                    r.f.Point({
        ...
        statement: Object(r.f)({
          ...
          points: [
            r.f.Point({
              name: "< 64KB",
              condition: (t) => {
                const { dataSize: e } = nt.extractDataSize(t);
        ...
        const s = new (class {
          constructor() {
            (this.cpuTimer = void 0),
              ...
              (this.config = { PERIOD: 3e3, HISTORY_SIZE: 100 }),
              (this.usageHistory = []),
              (this.listeners = []);
          }
          start(e) {
          ...
          onChange(t, e) {
            this.listeners.length &&
              ...
              this.listeners.push({ id: t, callback: e });
          }
          removeListener(t) {
            this.listeners.length &&
              (this.listeners = this.listeners.filter((e) => e.id !== t));
            ...
            const n = t.cpuUsage(),
              ...
              r =
                ((n.user -
                  ...
                  s) *
                100,
              a = Object(o.a)(Object(o.a)({}, n), {}, { time: s, percent: r });
            (this.cpuUsage = n),
              (this.cpuTimer = new i.a()),
              this.usageHistory.push({ data: a, ts: Date.now() }),
          ...
          getUsage() {
            ...
            return Object(o.a)(Object(o.a)({}, e), {}, { time: n, percent: i });
          }
        })();
        e.a = s;
      }).call(this, n("ckNr"));
        ...
        (I = class {
          ...
          async _measureLocalStorageSize() {
            try {
              ...
              for (let t = 0; t < i; t++) {
                ...
                if (e) {
                  const t = { keySize: Object(m.a)(e), valueSize: 0 };
                  l.push(
                    new Promise((i) => {
                      try {
          ...
          async _countTotalMsgs() {
            try {
              ...
              null === (t = c.a.UIManager.Tool) ||
                void 0 === t ||
                t.visualizeInfo({ text: `metrics/total_msgs: ${o}` }),
                this.Logger.zsymb(
                  5,
                  16652,
                  30010,
          ...
          visualizeProcessList(t, e) {
            if (null != t && t.length) {
              ...
              if (i)
                null === (n = c.a.UIManager.Tool) ||
                  void 0 === n ||
                  n.visualizeInfo({ text: `${i.name || i.type}|${i.pid} 👊🏽` }),
                  setTimeout(() => {
        ...
        constructor(t, e) {
          (this.onRevoke = t),
            ...
            (this.recordFpsHistory = (t) => {
              this.fpsResult.fpsHistory.push({ fps: t.fps, ts: t.now });
            }),
            (this.fpsDropMonitor = new s.default(this.config)),
            (this.fpsResult = { fpsHistory: [], dropped: [] });
        }
        start() {
    ...
    cKAe: function (t, e, n) {
      ...
      var d = class {
        ...
        setupOnce(t, e) {
          t((t, e) => {
            if (
              (this.logInfo("receive event", { event: t, hint: e }),
              this.config.enable)
            ) {
      ...
      function m(t) {
        const e = (t) => (t ? `${t.function} ${t.colno} ${t.lineno}` : ""),
          ...
          o = (function (t) {
            const { exception: e, stacktrace: n } = t;
            if (e)
              try {
      ...
      class u extends l {
        constructor() {
          super({ init: r.a }, new c("sentry-web"));
        }
        static getInstance() {
